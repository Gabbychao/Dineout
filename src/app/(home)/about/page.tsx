...
import GabImage from "@/assets/image/gab.png";
        ...
        <div className="flex gap-x-8 absolute w-full -top-16 justify-center">
          ...
          <div className="rounded-xl shadow-lg bg-white">
            ...
            <div className="flex flex-col gap-y-2 my-4">
              ...
              <h1 className="text-center font-medium">""</h1>
            </div>
          </div>
          <div className="rounded-xl shadow-lg bg-white">
            <Image
            ...
            <div className="flex flex-col gap-y-2 my-4">
              ...
              <h1 className="text-center font-medium">"bahala na si BATMAN"</h1>
            </div>
          </div>
          ...
          <div className="rounded-xl shadow-lg bg-white">
            ...
            />
            <div className="flex flex-col gap-y-2 my-4">
              <h1 className="text-center font-bold">Jeuz Vinci</h1>
              <h1 className="text-center font-medium">"I believe I can fly"</h1>
            </div>
          </div>
          <div className="rounded-xl shadow-lg bg-white">
            <Image
            ...
            <div className="flex flex-col gap-y-2 my-4">
              ...
              <h1 className="text-center font-medium">"Don't stop when you're tired. <br/> Stop when you're done."</h1>
            </div>
          </div>
        </div>
      </div>
